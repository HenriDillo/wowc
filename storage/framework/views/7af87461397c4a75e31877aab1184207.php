    ...
    <div class="flex-1 bg-white">
        ...
        <div class="p-6 space-y-6">
            ...
            <div x-show="activeTab === 'sales'" x-transition class="space-y-6">
                    ...
                    <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div>
                            ...
                            <select name="period" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring focus:ring-[#c49b6e]">
                                <option value="day" <?php echo e(request('period') == 'day' ? 'selected' : ''); ?>>Today</option>
                                <option value="week" <?php echo e(request('period') == 'week' ? 'selected' : ''); ?>>This Week</option>
                                <option value="month" <?php echo e(request('period') == 'month' ? 'selected' : ''); ?> selected>This Month</option>
                        ...
                        <?php if(request('period') == 'custom'): ?>
                            <div>
                                ...
                                <input type="date" name="custom_start" class="w-full px-3 py-2 border border-gray-300 rounded-lg" value="<?php echo e(request('custom_start')); ?>">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">End Date</label>
                                <input type="date" name="custom_end" class="w-full px-3 py-2 border border-gray-300 rounded-lg" value="<?php echo e(request('custom_end')); ?>">
                            </div>
                        <?php endif; ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-xl p-6">
                        ...
                        <div class="text-3xl font-bold text-blue-900">₱<?php echo e(number_format($totalSales ?? 0, 2)); ?></div>
                        <div class="text-xs text-blue-700 mt-2">From <?php echo e($startDate->format('M d, Y')); ?> to <?php echo e($endDate->format('M d, Y')); ?></div>
                    </div>
                    <div class="bg-gradient-to-br from-green-50 to-green-100 border border-green-200 rounded-xl p-6">
                        ...
                        <div class="text-3xl font-bold text-green-900"><?php echo e($totalOrders ?? 0); ?></div>
                ...
                <div class="bg-white border rounded-xl shadow-sm p-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <?php $__currentLoopData = $orderTypeBreakdown ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="bg-gray-50 rounded-lg p-4">
                                <div class="text-sm text-gray-600 capitalize"><?php echo e($type->order_type ?? 'N/A'); ?></div>
                                <div class="text-2xl font-bold text-gray-900"><?php echo e($type->count ?? 0); ?></div>
                                <div class="text-xs text-gray-500 mt-1">₱<?php echo e(number_format($type->total ?? 0, 2)); ?></div>
                            </div>
                ...
                <div class="bg-white border rounded-xl shadow-sm p-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <?php $__currentLoopData = $paymentMethodBreakdown ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="bg-gray-50 rounded-lg p-4">
                                <div class="text-sm text-gray-600 capitalize"><?php echo e(str_replace('_', ' ', $method->payment_method ?? 'N/A')); ?></div>
                                <div class="text-2xl font-bold text-gray-900"><?php echo e($method->count ?? 0); ?></div>
                                <div class="text-xs text-gray-500 mt-1">₱<?php echo e(number_format($method->total ?? 0, 2)); ?></div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
                ...
                <div class="bg-white border rounded-xl shadow-sm p-6 overflow-x-auto">
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $productSales ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="border-b hover:bg-gray-50">
                                    <td class="py-3 px-4 text-gray-900"><?php echo e($product->name); ?></td>
                                    <td class="text-right py-3 px-4 text-gray-700"><?php echo e($product->total_quantity); ?></td>
                                    <td class="text-right py-3 px-4 font-medium text-gray-900">₱<?php echo e(number_format($product->total_sales, 2)); ?></td>
                                </tr>
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $dailySales ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="border-b hover:bg-gray-50">
                                    <td class="py-3 px-4 text-gray-900"><?php echo e(\Carbon\Carbon::parse($day->date)->format('M d, Y')); ?></td>
                                    <td class="text-right py-3 px-4 text-gray-700"><?php echo e($day->orders); ?></td>
                                    <td class="text-right py-3 px-4 font-medium text-gray-900">₱<?php echo e(number_format($day->amount, 2)); ?></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr>
                                    <td colspan="3" class="text-center py-4 text-gray-500">No sales data</td>
            ...
            <div x-show="activeTab === 'inventory'" x-transition class="space-y-6">
                    ...
                    <div class="bg-red-50 border border-red-200 rounded-xl p-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-red-700 mt-1"><?php echo e($totalLowStock); ?> items below reorder level</p>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <div class="bg-white border rounded-xl shadow-sm p-6 overflow-x-auto">
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $itemsInventory ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="border-b hover:bg-gray-50">
                                    <td class="py-3 px-4 text-gray-900"><?php echo e($item->name); ?></td>
                                    <td class="text-right py-3 px-4 text-gray-700"><?php echo e($item->stock); ?></td>
                                    <td class="text-right py-3 px-4 text-gray-700"><?php echo e($item->reorder_level ?? 'N/A'); ?></td>
                                    <td class="text-center py-3 px-4">
                                        <?php if($item->stock <= ($item->reorder_level ?? 0)): ?>
                                            <span class="inline-block px-3 py-1 text-xs font-semibold bg-red-100 text-red-800 rounded-full">Low Stock</span>
                                        <?php elseif($item->stock <= (($item->reorder_level ?? 0) * 1.5)): ?>
                ...
                <div class="bg-white border rounded-xl shadow-sm p-6 overflow-x-auto">
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $materialsInventory ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $material): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="border-b hover:bg-gray-50">
                                    <td class="py-3 px-4 text-gray-900"><?php echo e($material->name); ?></td>
                                    <td class="text-right py-3 px-4 text-gray-700"><?php echo e($material->stock); ?></td>
                                    <td class="text-right py-3 px-4 text-gray-700"><?php echo e($material->reorder_level ?? 'N/A'); ?></td>
                                    <td class="text-center py-3 px-4">
                                        <?php if($material->stock <= ($material->reorder_level ?? 0)): ?>
                                            <span class="inline-block px-3 py-1 text-xs font-semibold bg-red-100 text-red-800 rounded-full">Low Stock</span>
                                        <?php elseif($material->stock <= (($material->reorder_level ?? 0) * 1.5)): ?>
                                            <span class="inline-block px-3 py-1 text-xs font-semibold bg-yellow-100 text-yellow-800 rounded-full">Moderate</span>
                                        <?php else: ?>
                                            <span class="inline-block px-3 py-1 text-xs font-semibold bg-green-100 text-green-800 rounded-full">Healthy</span>
                                        <?php endif; ?>
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $recentMovements ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $movement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="border-b hover:bg-gray-50">
                                    <td class="py-3 px-4 text-gray-900 font-medium"><?php echo e($movement->name); ?></td>
                                    <td class="text-center py-3 px-4">
                                        <span class="inline-block px-3 py-1 text-xs font-semibold rounded-full
                                            <?php if($movement->type === 'stock_in' || $movement->type === 'in'): ?>
                                                bg-green-100 text-green-800
                                            <?php elseif($movement->type === 'stock_out' || $movement->type === 'out'): ?>
                                                bg-red-100 text-red-800
                                            <?php else: ?>
                                                bg-gray-100 text-gray-800
                                            <?php endif; ?>
                                        ">
                                            <?php echo e(str_replace('_', ' ', ucfirst($movement->type))); ?>

                                        </span>
                                    </td>
                                    <td class="text-right py-3 px-4 text-gray-700 font-medium"><?php echo e($movement->quantity); ?></td>
                                    <td class="py-3 px-4 text-gray-600"><?php echo e($movement->remarks ?? '-'); ?></td>
                                    <td class="py-3 px-4 text-gray-500"><?php echo e($movement->created_at->diffForHumans()); ?></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr>
            ...
            <div x-show="activeTab === 'calendar'" x-transition class="space-y-6">
                <div x-data="{ calendarMonth: <?php echo e($month ?? now()->month); ?>, calendarYear: <?php echo e($year ?? now()->year); ?> }">
                    <div class="bg-white border rounded-xl shadow-sm p-6">
                        <div class="flex justify-between items-center mb-6">
                            ...
                            <div class="flex gap-2">
                                ...
                                <a href="?tab=calendar&month=<?php echo e(now()->month); ?>&year=<?php echo e(now()->year); ?>" class="px-3 py-1 text-xs font-medium text-[#c49b6e] hover:bg-amber-50 rounded-lg">Today</a>
                        ...
                        <div class="grid grid-cols-7 gap-1">
                            <?php for($date = $startDate; $date <= $endDate; $date->addDay()): ?>
                                ...
                                <div class="h-16 flex flex-col items-center justify-start text-sm border rounded-lg p-1
                                    <?php echo e($date->month != $calendarMonth ? 'bg-gray-50 text-gray-400' : 'bg-white text-gray-700'); ?>
                                    ...
                                    <?php if($hasEvent): ?>
                                        <div class="flex flex-wrap gap-0.5 mt-1 justify-center w-full">
                                            <?php if($restockCount > 0): ?>
                                                <span class="w-1.5 h-1.5 bg-purple-500 rounded-full" title="Restock: <?php echo e($restockCount); ?>"></span>
                                            <?php endif; ?>
                                            <?php if($deadlineCount > 0): ?>
                                                <span class="w-1.5 h-1.5 bg-orange-500 rounded-full" title="Deadline: <?php echo e($deadlineCount); ?>"></span>
                                            <?php endif; ?>
                                            <?php if($customCount > 0): ?>
                                                <span class="w-1.5 h-1.5 bg-pink-500 rounded-full" title="Custom: <?php echo e($customCount); ?>"></span>
                                            <?php endif; ?>
                                            <?php if($deliveryCount > 0): ?>
                                                <span class="w-1.5 h-1.5 bg-green-500 rounded-full" title="Delivery: <?php echo e($deliveryCount); ?>"></span>
                                            <?php endif; ?>
                                        </div>
                                        <span class="text-xs mt-0.5 font-medium text-[#c49b6e]"><?php echo e($totalEvents); ?></span>
                                    <?php endif; ?>
                                </div>
                            <?php endfor; ?>
                        </div>
...
<?php /**PATH C:\xampp\htdocs\wowc\resources\views/employee/reports/unified-report.blade.php ENDPATH**/ ?>