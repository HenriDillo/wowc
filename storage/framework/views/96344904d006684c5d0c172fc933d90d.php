    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="py-12 grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div>
                ...
                <ul class="space-y-2 text-gray-300">
                    <li><a href="<?php echo e(url('/custom-orders/create')); ?>" class="hover:text-[#c59d5f] transition-colors">Custom Order</a></li>
...
<?php /**PATH C:\xampp\htdocs\wowc\resources\views/partials/customer-footer.blade.php ENDPATH**/ ?>