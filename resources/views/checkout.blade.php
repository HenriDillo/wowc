			...
			<div class="mt-6 grid grid-cols-1 lg:grid-cols-2 gap-10">
                ...
                <div>
                    <form method="POST" action="{{ route('checkout.store') }}" class="bg-white border border-gray-100 rounded-xl shadow-sm p-6">
                        ...
                        <input type="email" value="{{ $user->email ?? '' }}" disabled class="mt-3 w-full rounded-md border-2 border-gray-300 px-3 py-2 bg-gray-50 text-gray-500 cursor-not-allowed"/>
                        ...
                        <div class="mt-3 grid grid-cols-1 sm:grid-cols-2 gap-3">
                            ...
                            <div>
                                <input name="first_name" value="{{ old('first_name', $user->first_name ?? '') }}" placeholder="First Name" class="w-full rounded-md border-2 {{ $errors->has('first_name') ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-[#c59d5f] focus:ring-[#c59d5f]' }} px-3 py-2 focus:outline-none transition-colors" required>
                                @error('first_name')
                                    <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            <div>
                                <input name="last_name" value="{{ old('last_name', $user->last_name ?? '') }}" placeholder="Last Name" class="w-full rounded-md border-2 {{ $errors->has('last_name') ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-[#c59d5f] focus:ring-[#c59d5f]' }} px-3 py-2 focus:outline-none transition-colors" required>
                                @error('last_name')
                                    <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="sm:col-span-2">
                                <input name="address_line" value="{{ old('address_line', $addr->address_line ?? '') }}" placeholder="Address" class="w-full rounded-md border-2 {{ $errors->has('address_line') ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-[#c59d5f] focus:ring-[#c59d5f]' }} px-3 py-2 focus:outline-none transition-colors" required>
                                @error('address_line')
                                    <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            <div>
                                <input name="city" value="{{ old('city', $addr->city ?? '') }}" placeholder="City" class="w-full rounded-md border-2 {{ $errors->has('city') ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-[#c59d5f] focus:ring-[#c59d5f]' }} px-3 py-2 focus:outline-none transition-colors" required>
                                @error('city')
                                    <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            <div>
                                <input name="postal_code" value="{{ old('postal_code', $addr->postal_code ?? '') }}" placeholder="Postal Code" class="w-full rounded-md border-2 {{ $errors->has('postal_code') ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-[#c59d5f] focus:ring-[#c59d5f]' }} px-3 py-2 focus:outline-none transition-colors" required>
                                @error('postal_code')
                                    <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            <div>
                                <input name="province" value="{{ old('province', $addr->province ?? '') }}" placeholder="Province" class="w-full rounded-md border-2 {{ $errors->has('province') ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-[#c59d5f] focus:ring-[#c59d5f]' }} px-3 py-2 focus:outline-none transition-colors" required>
                                @error('province')
                                    <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="sm:col-span-2">
                                <input name="phone_number" value="{{ old('phone_number', $addr->phone_number ?? '') }}" placeholder="Phone Number" class="w-full rounded-md border-2 {{ $errors->has('phone_number') ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-[#c59d5f] focus:ring-[#c59d5f]' }} px-3 py-2 focus:outline-none transition-colors" required>
                                @error('phone_number')
                                    <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
				...
				<div class="bg-white border border-gray-100 rounded-xl shadow-sm p-6">
					<h2 class="text-lg font-semibold text-gray-900">Order Summary</h2>
                        ...
                        @if($paymentOnly && isset($customOrder) && $customOrder)
                                ...
                                <div class="p-4 bg-amber-50 border border-amber-200 rounded-lg">
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-sm font-semibold text-gray-900">{{ $customOrder->custom_name }}</div>
                                        </div>
                                        ...
                                        @if($customOrder->description)
                                            <div>
                                                ...
                                                <div class="text-sm text-gray-700 whitespace-pre-line">{{ $customOrder->description }}</div>
                                            </div>
                                        @endif
                                        ...
                                        <div>
                                            ...
                                            <div class="text-sm text-gray-900">{{ $customOrder->quantity }}</div>
                                        </div>
                                                ...
                                                <div class="grid grid-cols-2 gap-2">
                                                    @foreach($images as $imagePath)
                                                        <div class="relative rounded-lg border border-gray-200 overflow-hidden bg-gray-50">
                                                            <img src="{{ \Illuminate\Support\Facades\Storage::url($imagePath) }}" alt="Reference Image {{ $loop->iteration }}" class="w-full h-32 object-cover">
                                                        </div>
                                                    @endforeach
                                                </div>
                                            </div>
                    ...
                    <div class="mt-6 border-t pt-4 space-y-2 text-sm">
                        ...
                        @elseif(($cartItems->contains(fn($ci) => ($ci->is_backorder ?? false)) && !$paymentOnly) || ($paymentOnly && ($payOrder->order_type === 'backorder' || $payOrder->order_type === 'custom')))
                            <div class="mt-3 space-y-2 border-t pt-3">
                                ...
                                @elseif($payOrder->order_type === 'custom')
                                    <h3 class="font-semibold text-gray-900">Payment Breakdown</h3>
                                @endif
                                
                                @if($paymentOnly && $payOrder->order_type === 'custom')
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="flex items-center justify-between p-2 bg-blue-50 rounded border border-blue-200">
                                            ...
                                            <span class="font-semibold text-blue-900">₱{{ number_format($requiredPaymentAmount, 2) }}</span>
                                        </div>
                                        <div class="flex items-center justify-between p-2 bg-gray-50 rounded border border-gray-200">
                                            <span class="text-gray-700">Remaining Balance (50%)</span>
                                            <span class="font-medium text-gray-900">₱{{ number_format($total - $requiredPaymentAmount, 2) }}</span>
                                        </div>
                                        <div class="flex items-center justify-between p-3 bg-amber-50 rounded border-2 border-amber-300 mt-2">
                                            <span class="font-bold text-amber-900">💰 Total Due Now</span>
                                            <span class="font-bold text-lg text-amber-900">₱{{ number_format($requiredPaymentAmount, 2) }}</span>
...
if (gcashConfirmBtn) {
	gcashConfirmBtn.addEventListener('click', async () => {
		...
		try{
			...
			const res = await fetch('{{ route('payments.gcash') }}', { 
				method:'POST', 
...
if (bankSubmitBtn) {
	bankSubmitBtn.addEventListener('click', async () => {
		...
		try{
			...
			const res = await fetch('{{ route('payments.bank') }}', { 
				method:'POST', 
				headers:{ 'X-CSRF-TOKEN': csrf }, 
				body: fd 
			});
