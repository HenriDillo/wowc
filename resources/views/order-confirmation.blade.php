		...
		<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                ...
                <div class="mt-2 text-sm flex flex-wrap gap-2">
					...
					<span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $statusColor }}">Status: {{ $statusLabel }}</span>
                </div>
				...
				<div class="space-y-6">
                    ...
                    <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
						...
						<div class="mt-3 text-sm text-gray-700 space-y-1">
							...
							@if($order->payment_status === 'partially_paid' && $order->remaining_balance > 0)
								<div class="pt-2 border-t mt-2 space-y-2">
									<div class="flex justify-between">
									...
									<div class="flex justify-between font-semibold bg-blue-50 p-2 rounded border border-blue-200">
										...
										<span class="text-blue-900">₱{{ number_format($order->remaining_balance, 2) }}</span>
									</div>
